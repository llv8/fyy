...
public enum ActionModel {
  ...
  RoleAdd(502001, ActionModel.ADD_ROLE, 501001),
  RoleUpdate(502002, ActionModel.UPDATE_ROLE, 501001),
  RoleDel(502003, ActionModel.DEL_ROLE, 501001),
  ...
  private static final String ADD_ROLE = "新增角色";
  private static final String UPDATE_ROLE = "编辑角色";
  private static final String DEL_ROLE = "删除角色";
  private static final String QUERY = "查询";
  private static final String CUST_PERM = "分配用户权限";
  private static final String ROLE_PERM = "分配角色权限";
